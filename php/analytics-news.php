...
<h1> Search </h1>
<div class="analytics-news-tag-search-container" id="analytics-news-tagSearchContainer">
<div class="analytics-news-selected-tags" id="analytics-news-selectedTags"></div>
<input class="form-control" id="analytics-news-tagSearch" placeholder="Search for theme or author..." type="text"/>
<button class="analytics-news-clear-search" id="analytics-news-clearSearch">x</button>
<ul class="analytics-news-suggestions" id="analytics-news-suggestions"></ul>
</div>
<div class="analytics-news-tag-container mt-2" id="analytics-news-tagContainer">
<!-- As tags serão preenchidas dinamicamente -->
</div>
</div>
<div class="row" id="analytics-news-newsContainer">
<!-- Os cards de notícias serão inseridos aqui -->
</div>
<button class="analytics-news-card-btn" id="analytics-news-loadMore" style="display: none;">Load More</button>
</div>
